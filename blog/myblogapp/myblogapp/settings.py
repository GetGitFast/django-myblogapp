...
""" 
LOGIN_REDIRECT_URL & LOGIN_URL are required to be set to override Django default redirection. 
More on this topic read - https://docs.djangoproject.com/en/1.8/_modules/django/contrib/auth/views/.
The login looks into settings.py for redirection-
